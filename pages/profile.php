...
try {
  ...
  if (!empty($accounts)) {
      ...
      $masked_email = preg_replace_callback(
        '/^[^@]+/', 
        function ($matches) {
            return str_repeat('*', strlen($matches[0])); // Mask the part before the '@'
        }, 
        $email
    );
  } else {
      ...
      <div class="container-fluid py-1">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="text-white opacity-5" href="javascript:;">InBank</a></li>
      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            ...
            <form action="../process/uploadpicprofile_process.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="../process/updateprofile_process.php">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="email-display" class="form-control" type="text" name="email" value="<?php echo htmlspecialchars($masked_email); ?>" disabled>
                        <!-- Store the original email in a hidden input field for backend use -->
        ...
        <div class="col-lg-4">
          <div class="card bg-transparent shadow-xl">
            <div class="overflow-hidden position-relative border-radius-xl" style="background-image: url('../assets/img/backgroud-card.jpg');">
              <span class="mask bg-gradient"></span>
              <div class="card-body position-relative z-index-1 p-3">
                <i class="fas fa-wifi text-white p-2"></i>
                <h5 class="text-white mt-4 mb-5 pb-2">
                  <?php 
                  $redacted_card_number = '**** **** **** ' . substr(str_replace(' ', '', $card_number), -4);
                  echo htmlspecialchars($redacted_card_number); 
                  ?>
                </h5>
                <div class="d-flex">
                  <div class="me-4">
