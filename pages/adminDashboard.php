          ...
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              ...
              <p class="text-sm mb-0">
                ...
                <span class="font-weight-bold">20% more</span> in 2024 than 2023
              </p>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-middle text-sm">
                      <div class="col text-center">
                        <p class="text-xs font-weight-bold mb-0">Interest Rate:</p>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="text-center">
                        <p class="text-xs font-weight-bold mb-0">Rate:</p>
                        <h6 class="text-sm mb-0">1.562</h6>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Malaysia Energy Sdn. Bhd.</h6>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Malaysia Flight Sdn. Bhd.</h6>
                      <span class="text-xs">123 in stock, <span class="font-weight-bold">15 sold</span></span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">AntiMal Sdn. Bhd.</h6>
                      <span class="text-xs">1 in stock, <span class="font-weight-bold">40 sold</span></span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">PayBuddies Sdn. Bhd./h6>
                      <span class="text-xs font-weight-bold">+ 430 in stocks</span>
                    </div>
                  </div>
                </li>
              </ul>
