...
$stmt = $conn->prepare("
    SELECT activity_type, activity_time, username
    FROM activities 
...
$username = $activities[0]['username'] ?? null;
$activity_type = $activities[0]['activity_type'] ?? null;
$activity_time = $activities[0]['activity_time'] ?? null;
?>
